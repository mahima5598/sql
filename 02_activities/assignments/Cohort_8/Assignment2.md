...
Ans: In image Prompt1.drawio.png

#### Prompt 2
We want to create employee shifts, splitting up the day into morning and evening. Add this to the ERD.

Ans: In image Prompt2.drawio.png
...
```
Type 1 overwrites and type 2 retains changes, architectures proposed in image Prompt3.drawio.png
```
